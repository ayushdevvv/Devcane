 ...
 <div>
  ...
  <div className="flex gap-2.5 sm:gap-3">
    {[
      {
        icon: FiGithub,
        link: "https://github.com/ayushdevvv/Devcane",
      },
      {
        icon: FiLinkedin,
        link: "https://www.linkedin.com/in/ayush-dixit-4b67b13b6/",
      },
      ...
      <a
        ...
        className="h-10 w-10 sm:h-11 sm:w-11 rounded-xl sm:rounded-2xl bg-[#0a1428] border border-[#1a2d4a] flex items-center justify-center text-slate-500 hover:text-white hover:border-[#22c55e]/25 transition"
      >
        <Icon size={16} />
      </a>
    ))}
