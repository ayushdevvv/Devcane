import { FiZap, FiCode, FiShield, FiGitBranch, FiFileText, FiFilePlus } from "react-icons/fi";
...
const features = [
  ...
  { icon: FiFileText, title: "Resume Analyzer",    desc: "ATS scoring, keyword gap analysis and AI-powered improvement reports.",    color: "text-blue-400 bg-blue-500/10 border-blue-500/15" },
  { icon: FiFilePlus, title: "Resume Builder",     desc: "Build a professional resume from scratch with AI-powered suggestions.",    color: "text-[#f59e0b] bg-[#f59e0b]/10 border-[#f59e0b]/15" },
];
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 sm:gap-7">
        {features.map(({ icon: Icon, title, desc, color }) => (
          <div key={title} className="group rounded-2xl sm:rounded-3xl border border-[#1a2d4a] bg-[#060d1a] p-6 sm:p-8 hover:border-blue-500/20 hover:-translate-y-1 transition duration-300">
