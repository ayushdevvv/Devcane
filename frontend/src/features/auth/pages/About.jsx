      ...
      <div className="relative z-10">
        ...
        <section className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <p className="text-slate-400 text-lg leading-relaxed max-w-2xl mx-auto">
            Devcane started as a simple idea — what if every developer had a senior engineer sitting next to them, available 24/7? We built that.
          </p>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 pb-24">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: FiCode, title: "AI Coding Assistant", desc: "Kyro — your AI senior engineer. Generates, debugs, and reviews code at production quality.", color: "text-[#22c55e]", bg: "bg-[#22c55e]/10", border: "border-[#22c55e]/20", status: "Live" },
              { icon: FiFileText, title: "Resume Analyzer", desc: "ATS scoring, keyword gap analysis, and AI-powered suggestions to land your dream role.", color: "text-[#f59e0b]", bg: "bg-[#f59e0b]/10", border: "border-[#f59e0b]/20", status: "Soon" },
              { icon: FiBook, title: "Study Content", desc: "Curated dev roadmaps and deep-dive learning paths powered by AI.", color: "text-blue-400", bg: "bg-blue-400/10", border: "border-blue-400/20", status: "Soon" },
